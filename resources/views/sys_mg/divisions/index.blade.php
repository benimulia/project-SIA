...
@section('content')
<div class="container">
    <h4 class="grey-text text-darken-2 center">Manajemen Divisi</h4>
        ...
        <ul class="collapsible">
            <li>
                ...
                <div class="collapsible-body">
                    <div class="row mb-0">
                        <form action="{{route('divisions.search')}}" method="POST">
                            @csrf()
                            <div class="input-field col s12 m6 l5 xl6">
                                <input id="search" type="text" name="search" >
                                <label for="search">Search by Nama Divisi</label>
    ...
    <div class="row">
        ...
        <div class="card col s12 m12 l12 xl12">
            <div class="card-content">
                <div class="row">
                    <h5 class="pl-15 grey-text text-darken-2">Daftar Divisi</h5>
                    ...
                    <table class="responsive-table col s12 m12 l12 xl12">
                        ...
                        <tbody>
                            ...
                            @else
                                ...
                                <tr>
                                    <td colspan="5"><h6 class="grey-text text-darken-2 center">Data divisi tidak ditemukan!</h6></td>
                                </tr>
                            @endif
                            @if(isset($search))
                                <tr>
