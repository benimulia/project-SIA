    ...
    <div class="container">
        <div class="row">
            <div class="card col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2 card-mt-15">
                <h4 class="center grey-text text-darken-2 card-title">Tambah Potongan</h4>
                <div class="card-content">
                    <div class="row">
                        <form action="{{route('potongans.store')}}" method="POST">
                            <div class="input-field no-margin">
                                <i class="material-icons prefix">money_off</i>
                                <input type="text" name="potongan_name" id="potongan_name" class="validate" value="{{ Request::old('potongan_name') ? : '' }}">
                            ...
                            <div class="input-field no-margin">
                                ...
                                <input type="text" name="jml_potongan" id="jml_potongan" class="validate" value="{{ Request::old('jml_potongan') ? : '' }}">
