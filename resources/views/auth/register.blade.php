            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="tmpt_lahir" class="col-md-4 col-form-label text-md-right">{{ __('Tempat Lahir') }}</label>

                            <div class="col-md-6">
                                <input id="tmpt_lahir" type="text" class="form-control @error('tmpt_lahir') is-invalid @enderror" name="tmpt_lahir" value="{{ old('tmpt_lahir') }}" required autocomplete="tmpt_lahir" autofocus>
