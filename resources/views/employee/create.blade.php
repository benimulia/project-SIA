    ...
    <div class="container">
        <div class="row">
            <div class="card col s12 m12 l12 xl12 mt-20">
                <div>
                <h4 class="center grey-text text-darken-2 card-title">Tambah Pegawai Baru</h4>
                </div>
                <hr>
                    ...
                    <form action="{{route('employees.store')}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6 l6 xl4 offset-xl2">
                                ...
                                <select name="state">
                                    <option value="" disabled {{ old('state') ? '' : 'selected' }} >Pilih provinsi</option>
                            ...
                            <div class="input-field col s12 m12 l12 xl8 offset-xl2">
                                ...
                                <select name="country">
                                    <option value="" disabled {{ old('country') ? '' : 'selected' }}>Pilih negara</option>
