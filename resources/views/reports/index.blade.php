...
<div class="container">
    <h4 class="grey-text text-darken-1">Laporan Pegawai</h4>
    ...
    <div class="card-content">
        <div class="row">
            <h5 class="pl-15 grey-text text-darken-2">Daftar Pegawai</h5>
            ...
            <table class="responsive-table col s12 m12 l12 xl12">
                ...
                <tbody id="emp-table">
                    ...
                    @else
                        ...
                        <tr>
                            <td colspan="5"><h6 class="grey-text text-darken-2 center">Data pegawai tidak ditemukan!</h6></td>
                        </tr>
                    @endif
                </tbody>
            </table>
