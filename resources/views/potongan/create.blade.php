...
@section('content')
<div class="container">
  <form action="/potongan/create" method="post" class="was-validated">
  {{ csrf_field() }}
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="jml_potongan" placeholder="Angka" name="jml_potongan" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
